...
//EXEMPLOS F1
pub fn processamento.calcula_total_invasoes_examples() {
...
//EXEMPLOS F2
pub fn processamento.instancia_evento_examples() {
...
//EXEMPLOS F3
pub fn processamento.classifica_evento_examples() {
...
//EXEMPLOS F5
pub fn processamento.mascara_ip_examples() {
...
//EXEMPLOS F8
pub fn processamento.calcula_media_examples() {
    let evento1 = tipos.Evento(1, "Computador 1", tipos.Malware, tipos.Alta, 3, tipos.EmAnalise)
    let evento2 = tipos.Evento(2, "Computador 2", tipos.AcessoSuspeito, tipos.Media, 1, tipos.Desconhecido)
    let evento3 = tipos.Evento(3, "Computador 3", tipos.TentativaDeLogin, tipos.Baixa, 5, tipos.Resolvido)
...
//EXEMPLOS F10
pub fn processamento.imprime_relatorio_examples() {
